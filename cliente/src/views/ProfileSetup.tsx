...
export default function ProfileSetup({ onDone }: { onDone: () => void }) {
  ...
  if (showAccessibilityPrompt) {
    return (
      <div className="client-dark-theme flex min-h-screen flex-col items-center justify-center bg-slate-950 px-5 py-8 text-slate-100">
  ...
  return (
    <div className="client-dark-theme flex min-h-screen flex-col bg-slate-950 text-slate-100">
      {/* Progress */}
