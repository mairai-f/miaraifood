...
export default function Reservation({
  ...
  return (
    <div className="client-reservation client-dark-theme min-h-screen bg-slate-950 text-slate-100">
      <header className="client-menu-header flex items-center gap-3 border-b border-slate-800 px-4 py-3">
