...
export const hasRegisteredBefore = (): boolean => lsGet<boolean>('miar_client_has_registered', false);
export const markRegisteredBefore = () => lsSet('miar_client_has_registered', true);
