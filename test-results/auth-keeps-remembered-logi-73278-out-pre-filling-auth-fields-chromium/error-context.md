...
- Name: auth.spec.ts >> keeps remembered login mode without pre-filling auth fields
- Location: tests/e2e/auth.spec.ts:42:1
...
Locator: getByRole('tab', { name: 'Operacional' })
Expected: "true"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveAttribute" getByRole('tab', { name: 'Operacional' }) with timeout 5000ms
