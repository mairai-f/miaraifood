...
const APPS = [
  ...
  { id: 'atendente',     nome: 'Atendente',       icon: Users,      porta: 5177, desc: 'Atendimento de mesa' },
              ...
              <div className="rounded-2xl border border-slate-800 divide-y divide-slate-800/60">
                {[
                  ...
                  },
                  {
                    ...
                    d: 'Digite o IP acima, clique em Testar. Depois escaneie os QR codes em cada tablet. Pronto — caixa, cozinha e atendente funcionam sem internet.',
                  },
                ].map(({ n, t, d }) => (
