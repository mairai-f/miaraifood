...
export default function RegistroProtegido() {
  ...
  return (
    <div className="relative min-h-screen bg-[#06100A] px-5 py-10 text-[#F2F7F3] overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <Particles
          particleColors={["#008000", "#38B000", "#16301F", "#ffffff"]}
          particleCount={180}
          particleSpread={10}
          speed={0.12}
          particleBaseSize={90}
      ...
      <div className="relative z-10 mx-auto w-full max-w-3xl">
        ...
        {fase === 'intro' && !configurado && (
          <Intro
            ...
            onDepois={async () => {
              await api('pular');
              toast.info('Cadastro pausado. Faça login para continuar.');
              setLocation('/login');
            }}
          />
        )}
