  ...
  return (
    <motion.button
      ...
      className={`rounded-lg p-1.5 transition-colors ${
        state === 'idle'
          ? 'text-slate-600 hover:text-[#CCFF33]'
          : state === 'playing'
          ? 'text-[#CCFF33] hover:text-amber-400'
...
function MessageBubble({
  ...
  return (
    ...
    >
      {isMia && (
        <div className="size-7 rounded-full bg-gradient-to-br from-[#38B000] to-[#9EF01A] flex items-center justify-center shrink-0 mt-1 shadow-md shadow-[#38B000]/20">
        ...
        <div
          className={`relative rounded-2xl px-4 py-3 text-sm leading-relaxed whitespace-pre-wrap select-text ${
            isMia
              ...
              : 'bg-[#38B000]/20 border border-[#38B000]/30 text-slate-100 rounded-tr-sm'
          }`}
        >
          {msg.content}
...
export default function MiaPage() {
  ...
  const send = async () => {
    ...
    try {
      ...
      const token = localStorage.getItem('miar-owner-token');
      const res = await fetch(`${apiBaseUrl}/api/mia`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="miar-ai-workspace flex h-screen bg-slate-950 text-slate-100 overflow-hidden">
        ...
        {sidebarOpen && (
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-4 border-b border-slate-800">
              <div className="size-8 rounded-xl bg-gradient-to-br from-[#38B000] to-[#9EF01A] flex items-center justify-center shadow-lg shadow-[#38B000]/20">
              ...
              <div className="ml-auto flex items-center gap-1">
                ...
                <button
                  ...
                  className="rounded-lg p-1.5 text-slate-500 hover:text-[#CCFF33] transition-colors"
            ...
            <div className="flex gap-2 px-3 py-3 border-b border-slate-800">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 rounded-xl bg-[#38B000]/15 border border-[#38B000]/25 py-2 text-xs font-semibold text-[#38B000] hover:bg-[#38B000]/25 transition-colors"
              >
                ...
                >
                  <div className="px-3 py-2 flex gap-2">
                    <input
                      ...
                      className="flex-1 rounded-lg bg-slate-800 border border-slate-700 px-2.5 py-1.5 text-xs text-slate-100 placeholder:text-slate-500 focus:border-[#38B000]/50 focus:outline-none"
                    />
                    <button onClick={createFolder} className="rounded-lg bg-[#38B000] px-2.5 py-1.5 text-xs font-bold text-white hover:bg-[#9EF01A]">
                      Criar
                    </button>
                  ...
                  <div className="group flex items-center gap-1.5 rounded-xl px-2 py-1.5 hover:bg-slate-800/60 transition-colors">
                    ...
                    <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="rounded-lg p-1 text-slate-500 hover:text-[#38B000]"
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex items-center gap-3 px-4 py-3 border-b border-slate-800 bg-slate-900/60 backdrop-blur-md shrink-0">
          ...
          <button
            onClick={createLooseConv}
            className="rounded-xl p-2 text-slate-500 hover:text-[#38B000] hover:bg-[#38B000]/10 transition-colors"
            title="Nova conversa"
          >
        ...
        <div ref={chatRef} className="flex-1 overflow-y-auto px-4 py-6 space-y-5">
          ...
          {loading && (
            <div className="flex gap-2.5 justify-start">
              <div className="size-7 rounded-full bg-gradient-to-br from-[#38B000] to-[#9EF01A] flex items-center justify-center shrink-0 mt-1">
                <Brain size={14} className="text-white" />
              </div>
              <div className="rounded-2xl rounded-tl-sm bg-slate-800 border border-slate-700 px-4 py-3">
                <div className="flex gap-1.5 items-center">
                  {[0, 1, 2].map(i => (
                    <motion.div
                      key={i}
                      className="size-2 rounded-full bg-[#38B000]"
        ...
        <AnimatePresence>
          {selectionText && selectionPos && (
            <motion.button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-slate-800 border border-[#CCFF33]/40 px-3 py-1.5 text-xs font-semibold text-[#CCFF33] shadow-xl shadow-slate-950/50 hover:bg-slate-700 transition-colors"
            >
        ...
        <div className="px-4 pb-4 pt-2 border-t border-slate-800 bg-slate-950/80 shrink-0">
          <div className="rounded-2xl border border-slate-700 bg-slate-900 focus-within:border-[#38B000]/50 transition-colors shadow-lg">
            <textarea
              ref={textareaRef}
              value={input}
            ...
            <div className="flex items-center gap-2 px-3 pb-2.5 pt-1">
              ...
              <motion.button
                ...
                className="rounded-xl bg-[#38B000] p-2.5 text-white shadow-md shadow-[#38B000]/25 hover:bg-[#9EF01A] disabled:opacity-40 disabled:cursor-not-allowed transition-all"
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-slate-100 focus:border-[#38B000]/50 focus:outline-none"
              />
              <div className="mt-3 flex justify-end gap-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-[#38B000] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#9EF01A]"
                >Salvar</button>
              </div>
            </motion.div>
          </motion.div>
...
function ConvItem({
  ...
  return (
    <div className={`group flex items-center gap-1 rounded-xl transition-colors cursor-pointer ${
      active ? 'bg-[#38B000]/15 border border-[#38B000]/25' : 'hover:bg-slate-800/60 border border-transparent'
    } ${indent ? 'ml-2' : ''}`}>
      <button onClick={onClick} className="flex-1 min-w-0 px-3 py-2 text-left">
        <p className={`text-xs font-medium truncate ${active ? 'text-[#38B000]' : 'text-slate-400'}`}>
...
function EmptyState({ onSend }: { onSend: (t: string) => void }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center px-6 py-10 gap-8">
      <div>
        <div className="size-16 rounded-3xl bg-gradient-to-br from-[#38B000] to-[#9EF01A] flex items-center justify-center mx-auto mb-4 shadow-xl shadow-[#38B000]/25">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full max-w-2xl">
        {suggestions.map((s, i) => (
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            onClick={() => onSend(s)}
            className="text-left rounded-2xl border border-slate-700/60 bg-slate-900/60 px-4 py-3 text-sm text-slate-400 hover:border-[#38B000]/30 hover:text-slate-300 hover:bg-slate-900 transition-all"
          >
            {s}
          </motion.button>
        ))}
