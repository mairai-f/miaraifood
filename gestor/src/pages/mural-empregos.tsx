...
const C = {
  base: 'var(--miar-base, #06100A)',
  surface: 'var(--miar-surface, #0B1A10)',
  text: 'var(--miar-text, #F2F7F3)',
  muted: 'var(--miar-muted, #8FA396)',
  line: 'var(--miar-line, #16301F)',
  ciano: 'var(--miar-ciano, #9EF01A)',
};
        ...
        {showForm && (
          <div style={{ background: C.surface, border: `1px solid ${C.line}`, borderRadius: 14, padding: 16, marginBottom: 20 }}>
            <div style={{ display: 'grid', gap: 10 }}>
              <input
                placeholder="Título da vaga (ex.: Atendente para fins de semana)"
                value={form.titulo}
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                <input
                  placeholder="Cargo (ex.: Atendente, Cozinheiro)"
                  value={form.cargo}
