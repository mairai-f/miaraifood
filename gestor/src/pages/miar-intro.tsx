  ...
  return (
    <div className="rounded-2xl border border-slate-700/60 bg-slate-900/60 overflow-hidden">
      <div className="px-4 py-3 border-b border-slate-700/60 flex items-center gap-2">
        <div className="size-2 rounded-full bg-[#38B000]" />
      ...
      <div className="p-4 space-y-3">
        {ex.messages.map((m, i) => (
          <div key={i} className={`flex gap-3 ${m.role === 'user' ? 'justify-end' : 'justify-start'}`}>
            {m.role === 'miar' && (
              <div className="size-7 rounded-full bg-gradient-to-br from-[#38B000] to-[#9EF01A] flex items-center justify-center shrink-0 mt-0.5">
                <Brain size={14} className="text-white" />
              </div>
            )}
            <div className={`max-w-[85%] rounded-2xl px-3.5 py-2.5 text-sm leading-relaxed ${
              m.role === 'user'
                ? 'bg-[#38B000]/20 border border-[#38B000]/30 text-slate-200 rounded-tr-sm'
...
export default function MIARIntroPage() {
  ...
  return (
    <div className="miar-ai-intro min-h-screen bg-slate-950 text-slate-100">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[90vh] px-6 text-center overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 size-[500px] rounded-full bg-[#38B000]/8 blur-[120px]" />
          <div className="absolute top-2/3 left-1/3 size-[300px] rounded-full bg-[#CCFF33]/6 blur-[100px]" />
        </div>
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[#38B000]/30 bg-[#38B000]/10 px-4 py-1.5 text-sm text-[#38B000] mb-6"
          >
            <Brain size={14} />
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight mb-6">
            Sua parceira.{' '}
            <span className="bg-gradient-to-r from-[#38B000] to-[#9EF01A] bg-clip-text text-transparent">
              Não um chatbot.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <motion.button
              ...
              className="flex items-center gap-2 rounded-2xl bg-[#38B000] px-7 py-3.5 font-bold text-white shadow-lg shadow-[#38B000]/25 hover:bg-[#9EF01A] transition-colors"
            >
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        <FadeIn>
          <div className="rounded-3xl border border-[#38B000]/20 bg-gradient-to-br from-[#38B000]/8 to-transparent p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-[#38B000] mb-3">A filosofia</p>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 rounded-xl bg-slate-900/60 border border-slate-800 px-4 py-3">
                    <Icon size={16} className="text-[#38B000] shrink-0" />
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        <FadeIn>
          <div className="text-center mb-12">
            <p className="text-xs font-bold uppercase tracking-widest text-[#CCFF33] mb-3">Os 4 pilares</p>
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        <FadeIn>
          <div className="text-center mb-12">
            <p className="text-xs font-bold uppercase tracking-widest text-[#38B000] mb-3">O fluxo</p>
          ...
          {[
            ...
            <FadeIn key={i} delay={i * 0.1} className="flex items-center gap-4">
              <div className="flex flex-col items-center">
                <div className="size-12 rounded-2xl bg-gradient-to-br from-[#38B000] to-[#9EF01A] flex items-center justify-center font-black text-white text-lg shrink-0">
                  {item.step}
                </div>
      ...
      <section id="como-treinar" className="px-6 py-20 max-w-5xl mx-auto">
        <FadeIn>
          <div className="text-center mb-12">
            <p className="text-xs font-bold uppercase tracking-widest text-[#CCFF33] mb-3">O manual</p>
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        <FadeIn>
          <div className="text-center mb-12">
            <p className="text-xs font-bold uppercase tracking-widest text-[#38B000] mb-3">Na prática</p>
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        <FadeIn>
          <div className="text-center mb-12">
            <p className="text-xs font-bold uppercase tracking-widest text-[#CCFF33] mb-3">Honestidade antes de tudo</p>
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        <FadeIn>
          <div className="rounded-3xl border border-[#CCFF33]/20 bg-gradient-to-br from-[#CCFF33]/5 to-transparent p-8 md:p-12">
            <div className="text-center mb-10">
              <p className="text-xs font-bold uppercase tracking-widest text-[#CCFF33] mb-3">A interface</p>
              ...
              {[
                ...
                <div key={i} className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    <div className="rounded-lg p-2 bg-[#CCFF33]/10">
                      <Icon size={16} className="text-[#CCFF33]" />
                    </div>
        ...
        <FadeIn>
          <div className="relative max-w-2xl mx-auto">
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <div className="size-[400px] rounded-full bg-[#38B000]/10 blur-[80px]" />
            </div>
            <div className="relative z-10">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                onClick={() => navigate('/mia')}
                className="inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-[#38B000] to-[#9EF01A] px-10 py-4 text-lg font-black text-white shadow-2xl shadow-[#38B000]/30 hover:shadow-[#38B000]/50 transition-shadow"
              >
                <Brain size={22} />
