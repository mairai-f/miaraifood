...
import { ShoppingCart, Bot, Send, ChevronDown, ChevronUp, Loader2, AlertCircle, PackageCheck, AlertTriangle, Check } from 'lucide-react';
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-xl font-semibold flex items-center gap-2">
              <ShoppingCart className="h-5 w-5 text-violet-400" /> {t('compras.titulo')}
            </h1>
          </div>
        </div>
