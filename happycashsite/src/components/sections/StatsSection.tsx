...
export default function StatsSection({ scrollYProgress, showOnly }: { scrollYProgress?: any, showOnly?: 'top' | 'bottom' }) {
    ...
    useEffect(() => {
        const galleryImages = [
            { src: '/telas/pdv.webp', alt: 'PDV HappyCash' },
            { src: '/telas/pdvfinalizandovenda.webp', alt: 'Finalizando Venda' },
            { src: '/telas/clientes.webp', alt: 'Fiado Digital' },
            { src: '/telas/estoque.webp', alt: 'Controle de Estoque' },
            { src: '/telas/Financeiro.webp', alt: 'Gestão Financeira' },
            { src: '/telas/relatorios.webp', alt: 'Relatórios' },
            { src: '/telas/comandas.webp', alt: 'Comandas' },
            { src: '/telas/notafiscal.webp', alt: 'Nota Fiscal' },
            { src: '/telas/precificaçao.webp', alt: 'Precificação' },
            { src: '/telas/produtos.webp', alt: 'Cadastro de Produtos' },
        ];
            ...
            {(showOnly === 'top' || !showOnly) && (
                <>
                    <div className="max-w-6xl mx-auto px-6 w-full pt-32 pb-16 text-center space-y-4">
                        ...
                        >
                            Veja a plataforma em ação através de telas do sistema e conteúdos que mostram como o HappyCash transforma a rotina empresarial.
                        </motion.p>
                    </div>
