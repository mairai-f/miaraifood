      ...
      <main className="relative flex-1 flex flex-col justify-center pt-40 pb-20 z-10 max-w-[105rem] w-full mx-auto">
        <div className="flex relative gap-4 px-6 md:items-center w-full flex-col justify-center">
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              Gestão inteligente para pequenos,medios e grandes negócios.
                  Venda, controle e acompanhe sua empresa em um único sistema.
            </motion.p>
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              ...
              <div
                ...
                onMouseEnter={(e) => setTooltip({ show: true, text: "Teste grátis", icon: 'bot', x: e.clientX, y: e.clientY })}
                onMouseMove={(e) => setTooltip(prev => ({ ...prev, x: e.clientX, y: e.clientY }))}
                onMouseLeave={() => setTooltip(prev => ({ ...prev, show: false }))}
              >
            ...
            >
              Sistema completo para simplificar
a gestão do seu negócio.
      ...
      >
        ...
        <div className="relative z-50">
          <motion.div
            whileHover={{ x: 6 }}
            className="bg-gradient-to-b from-blue-600 to-blue-800 text-white py-10 px-4 text-[10px] font-black uppercase tracking-[0.5em] shadow-2xl rounded-r-3xl border-r border-y border-blue-400 cursor-pointer"          >
        ...
        <AnimatePresence>
          {showProfile && (
            ...
            >
              <div className="bg-white dark:bg-[#161616] rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-10 w-[450px] border border-black/5 dark:border-white/5 flex flex-col justify-center">
                <div className="mb-6">
                  <h2 className="text-3xl font-bold text-black dark:text-white mb-2 tracking-tight">
                ...
                <p className="text-zinc-600 dark:text-zinc-400 text-base leading-relaxed mb-10">
                  O HappyCash ERP conecta vendas, estoque, clientes e financeiro em uma plataforma simples, rápida e inteligente. Cadastre-se sem compromisso e veja sua empresa crescer.
                </p>
                <div className="flex gap-4">
                  <Link
                    href="/cadastro?plan=demo"
                    target="_blank"
                    className="flex-1 bg-black dark:bg-white text-white dark:text-black py-4 rounded-xl font-bold text-center hover:scale-[1.02] transition-transform"
                  >
                    Criar Conta
                  </Link>
                  <Link
                    href="/planos"
                    className="flex-1 bg-zinc-100 dark:bg-zinc-800 text-black dark:text-white py-4 rounded-xl font-bold text-center hover:scale-[1.02] transition-transform"
                  >
                    Ver Planos
                  </Link>
                </div>
