...
function ExperienceContent() {
    return (
        ...
        >
            ...
            <h3 className="text-2xl font-bold text-foreground">Evolução Contínua</h3>
            <p className="text-muted-foreground max-w-md">
                O HappyCash está em evolução constante. Novos recursos, melhorias de desempenho e atualizações são desenvolvidos continuamente para tornar a gestão do seu negócio cada vez mais simples e eficiente.
            </p>
        </motion.div>
    );
}
        ...
        <div className="py-16 space-y-12">
            ...
            >
                ...
                <p className="text-center text-muted-foreground mt-2 max-w-md mx-auto">
                    ...
                    {activeTab === 'journey' && 'Uma linha do tempo das implementações, melhorias estruturais e avanços que moldaram a plataforma HappyCash ERP.'}
