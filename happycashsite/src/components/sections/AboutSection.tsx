...
const showcaseMembers = [
    ...
    },
    {
        ...
        role: "Explore todos os módulos do HappyCash",
...
const GALLERY_IMAGES = [
    "/telas/Financeiro.webp",
    "/telas/clientes.webp",
    "/telas/comandas.webp",
    "/telas/estoque.webp",
    "/telas/pdv.webp",
    "/telas/relatorios.webp",
    "/telas/pdvfinalizandovenda.webp",
    "/telas/produtos.webp"
];
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex justify-between items-start mb-6 md:mb-10">
                        <span className="text-red-600 dark:text-red-500 text-[10px] md:text-xs font-bold uppercase tracking-[0.3em]">VISÃO GERAL</span>
                        <span className="text-zinc-400 dark:text-zinc-600 text-[9px] font-mono tracking-widest uppercase hidden md:block">HAPPYCASH ERP</span>
                    </div>
                    ...
                    <div className="mb-8 md:mb-14 relative cursor-default">
                        ...
                        <h2 className="text-[32px] sm:text-[48px] md:text-[64px] lg:text-[76px] xl:text-[88px] font-bold tracking-tight leading-[0.92] text-zinc-900 dark:text-white transition-all duration-700 group-hover:drop-shadow-[0_0_15px_rgba(0,0,0,0.1)] dark:group-hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]">
                            ...
                            Simplificando <span className="text-zinc-400 dark:text-zinc-500 font-medium transition-colors duration-700 group-hover:text-zinc-600 dark:group-hover:text-zinc-300">Negócios</span>. <br className="hidden md:block" />
                            <span className="font-serif italic font-normal text-zinc-900 dark:text-white lowercase opacity-90 transition-opacity duration-700 group-hover:opacity-100">onde tecnologia encontra gestão</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 border-t border-zinc-100 dark:border-zinc-900 pt-8 md:pt-12">
                        ...
                        <div className="md:col-span-5">
                            <p className="text-base md:text-lg lg:text-xl font-medium text-zinc-600 dark:text-zinc-400 leading-relaxed tracking-tight">
                                O HappyCash ERP foi criado para ajudar empresas a terem mais controle sobre suas operações, oferecendo uma solução simples, moderna e eficiente.
                            </p>
                        </div>
                        ...
                        <div className="md:col-span-7 flex flex-col sm:flex-row gap-8 text-[13px]">
                            <div className="flex-1 space-y-3">
                                <span className="text-zinc-800 dark:text-zinc-200 font-bold uppercase tracking-widest block border-b border-zinc-100 dark:border-zinc-900 pb-3">Recursos</span>
                                <p className="text-zinc-500 leading-relaxed">
                                    Nossa plataforma combina tecnologia, facilidade de uso e recursos essenciais para transformar a maneira como empresas gerenciam suas vendas e processos.
                                </p>
                            ...
                            <div className="flex-1 space-y-3 flex flex-col">
                                <span className="text-zinc-800 dark:text-zinc-200 font-bold uppercase tracking-widest block border-b border-zinc-100 dark:border-zinc-900 pb-3">Experiência</span>
                                <p className="text-zinc-500 leading-relaxed">
                                    Projetado para ser intuitivo e escalável, ajudando você no dia a dia.
                                </p>
                                <div className="mt-6 md:mt-auto pt-4">
                                    <span className="text-3xl lg:text-4xl font-signature text-zinc-900 dark:text-white/90">HappyCash</span>
                                </div>
                            </div>
                        </div>
                    </div>
