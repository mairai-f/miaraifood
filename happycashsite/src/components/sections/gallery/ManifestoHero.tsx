    ...
    return (
        <section ref={containerRef} className="relative max-md:!h-auto max-md:!transform-none  text-foreground">
            <div className="max-md:!static max-md:!h-auto max-md:!transform-none sticky top-0  overflow-hidden flex flex-col items-center justify-center">
                ...
                <motion.div style={{ opacity }} className="relative z-10 px-4 md:px-12 max-w-7xl mx-auto text-center">
                    ...
                    >
                        <p className="text-lg md:text-xl font-serif text-muted-foreground leading-relaxed">
                            "Criamos soluções não apenas para controlar dados,
                                mas para simplificar rotinas, organizar empresas
                                    e ajudar pessoas a tomarem melhores decisões."      
                        </p>
                    </motion.div>
                ...
                >
                    <span className="text-[10px] font-mono uppercase tracking-widest text-muted-foreground">Role para ver mais</span>
