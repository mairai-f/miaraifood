            ...
            <div className="max-w-[1536px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20">
                <div className="relative z-10 w-full lg:w-1/2">
                    <BlockInTextCard
                        ...
                        text={
                            <>
                                <strong><Hover3DFlipText text="Pronto para transformar a gestão da sua empresa?" /></strong> <Hover3DFlipText text="Conheça o HappyCash ERP e descubra como controlar vendas, estoque, financeiro e clientes em uma única plataforma." />
                            </>
                        }
                        examples={[
                ...
                <div className="relative z-10 w-full lg:w-1/2 hidden md:flex justify-center lg:justify-end h-[400px] md:h-[500px]">
