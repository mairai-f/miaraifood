...
export default function CardNav({
    ...
    const aboutItem = items.find(i => i.label === "HappyCash") || items[0];
                        ...
                        <div className={cn(
                            ...
                            <div className="flex-1 p-5 flex flex-col gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <MegaBoxBig href="/sobre" icon={Briefcase} title="Sobre Nós" desc="A história e missão do HappyCash" theme={theme} pathname={pathname} />
                                </div>
                            ...
                            <div className={cn(
                                ...
                                <SidebarLink href="/telas" icon={ImageIcon} title="Telas do Sistema" desc="Demonstração visual do HappyCash" theme={theme} pathname={pathname} />
