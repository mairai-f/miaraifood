    ...
    >
      <div className="max-w-7xl mx-auto pt-20 pb-10 px-4 md:px-8 lg:px-10">
        ...
        >
          ...
          >
            Evolução contínua do HappyCash ERP
          </motion.h2>
          <motion.p
          ...
          >
            Uma linha do tempo das melhorias, decisões técnicas e avanços que fortaleceram a plataforma para oferecer uma gestão empresarial mais inteligente.
          </motion.p>
        </motion.div>
      </div>
