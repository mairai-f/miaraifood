...
const config = {
  ai: [
    { icon: Terminal, label: "PDV", color: "#ef4444" },
    { icon: Database, label: "CAIXA", color: "#3b82f6" },
    { icon: Layers, label: "ESTOQUE", color: "#eab308" },
    { icon: Code, label: "NOTAS", color: "#22c55e" },
    { icon: Users, label: "VENDAS", color: "#a855f7" },
    { icon: Briefcase, label: "FIADO", color: "#f97316" }
  ],
  software: [
    { icon: Database, label: "DADOS", color: "#3b82f6" },
    { icon: Zap, label: "LUCRO", color: "#eab308" },
    { icon: Layers, label: "DRE", color: "#22c55e" },
    { icon: Target, label: "MÉTRICA", color: "#ef4444" },
    { icon: Workflow, label: "FLUXO", color: "#8b5cf6" },
    { icon: Brain, label: "GRÁFICO", color: "#06b6d4" }
  ],
  softskill: [
    { icon: Server, label: "NUVEM", color: "#eab308" },
    { icon: Shield, label: "SEGURO", color: "#3b82f6" },
    { icon: Database, label: "BACKUP", color: "#22c55e" },
    { icon: MessageSquare, label: "AJUDA", color: "#ef4444" },
    { icon: Zap, label: "RÁPIDO", color: "#a855f7" },
    { icon: Network, label: "OFFLINE", color: "#f97316" }
  ],
  default: [
