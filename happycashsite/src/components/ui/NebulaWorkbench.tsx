...
export const NebulaWorkbench = ({ tools, className }: NebulaWorkbenchProps) => {
    ...
    return (
        <div ref={containerRef} className={`relative max-md:!min-h-0 max-md:!transform-none  flex flex-col items-center justify-center py-48 overflow-hidden ${className}`}>
