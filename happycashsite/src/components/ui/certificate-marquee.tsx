  ...
  return (
    <section className="relative w-full bg-background overflow-hidden pb-32">
          ...
          <div className="space-y-6 w-full">
            <div className="space-y-4">
              ...
              <h3 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-[1.1] tracking-tight max-w-none text-foreground">
               Uma plataforma construída com <span className="text-shiny">Tecnologia</span> moderna.
              </h3>
              <p className="text-lg text-muted-foreground max-w-none leading-relaxed lg:whitespace-nowrap">
              Pensada para oferecer segurança, desempenho e uma experiência simples para empresas,Recursos desenvolvidos para tornar a gestão
                mais rápida, organizada e inteligente.
              </p>
            </div>
          </div>
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 md:px-8 lg:px-12">
        <div
          ref={gallery}
          className="relative box-border flex max-md:!h-auto max-md:!transform-none  md:h-[130vh] gap-4 md:gap-6 overflow-hidden rounded-none"
        >
