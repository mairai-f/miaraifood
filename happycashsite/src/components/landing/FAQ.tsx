...
const faqs = [
  ...
  { q: "Como funciona o desktop PRO?", a: "Depois que o plano PRO estiver ativo, você baixa a release mais recente para Windows ou Linux. Em cada máquina nova, o app pede a chave da empresa, reconhece a loja, valida o primeiro acesso online e salva o ambiente para os próximos logins offline." },
  { q: "Quanto tempo o desktop pode ficar offline?", a: "Depois do primeiro acesso online e de uma validação da licença, o desktop PRO pode seguir offline por até 5 dias. Nesse período, o operador entra com usuário e PIN ou senha local, e quando faltar menos de 5 horas o sistema avisa para reconectar." },
