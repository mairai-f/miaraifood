...
const faqs = [
  ...
  { q: "Como funciona o desktop PRO?", a: "Depois que o plano PRO estiver ativo, você baixa a release mais recente para Windows ou Linux. Em cada máquina nova, o app pede a chave da empresa, reconhece a loja e só então libera o login do operador com usuário e PIN ou senha." },
  { q: "Quanto tempo o desktop pode ficar offline?", a: "Depois de uma validação online, o desktop PRO pode seguir offline por até 5 dias. Quando faltar menos de 5 horas para vencer, o sistema avisa para reconectar e validar de novo." },
