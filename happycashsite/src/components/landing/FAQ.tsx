...
const faqs = [
  ...
  { q: "Quanto tempo o desktop pode ficar offline?", a: "Depois do primeiro acesso online, do download dos dados e de uma validação da licença, o desktop PRO pode seguir offline por até 5 dias. Nesse período, o administrador ou operador entra com usuário e PIN ou senha local, e quando faltar menos de 5 horas o sistema avisa para reconectar." },
