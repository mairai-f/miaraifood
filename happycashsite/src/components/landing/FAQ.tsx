...
const faqs = [
  ...
  { q: "O HappyCash emite nota fiscal automaticamente?", a: "Não por padrão. O sistema pode operar com recibo interno e, nos planos compatíveis, oferecer módulo de NFC-e. Para emitir nota fiscal real, o estabelecimento precisa configurar seus próprios dados fiscais, certificado A1, CSC/credenciamento SEFAZ, produtos e orientação do contador." },
