...
const features = [
  ...
  { icon: Key, title: "Usuário e PIN offline", desc: "No desktop PRO, o primeiro login online vincula a máquina ao administrador, baixa os dados da loja e libera admin/operador com usuário e PIN ou senha local." },
];
