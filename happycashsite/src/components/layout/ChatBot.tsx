        ...
        <>
            ...
            <motion.div
                ...
                className={cn(
                    ...
                    isExpanded
                        ? "w-[calc(100vw-2rem)] sm:w-[600px] md:w-[700px] lg:w-[800px] h-[calc(100vh-2rem)] sm:max-md:!h-auto max-md:!transform-none  max-h-[800px]"
                        : "w-[calc(100vw-2rem)] sm:w-[420px] h-[600px] max-max-md:!h-auto max-md:!transform-none ",
