            ...
            {isLoading && (
                ...
                >
                    <motion.div
                        ...
                        className="relative flex flex-col items-center justify-center w-full max-w-[800px] will-change-transform px-6 text-center"
                    >
                        <h1 className="text-3xl md:text-5xl font-black text-foreground tracking-tight text-gradient">
                            Bem-vindos ao seu novo sistema de gestão
                        </h1>
                    </motion.div>
