                                ...
                                <div className="flex-1 flex flex-col justify-center max-w-[1600px] w-full mx-auto relative">
                                    ...
                                    <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-x-[5vw] gap-y-[4vh]">
                                        ...
                                        <FooterColumn title="Empresa">
                                            <FooterLink href="/sobre" onClick={closeExpanded}>Sobre o HappyCash</FooterLink>
                                        ...
                                        <FooterColumn title="Contato">
                                            <FooterLink href="https://wa.me/5512988918792?text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20o%20HappyCash!" target="_blank" onClick={closeExpanded}>WhatsApp</FooterLink>
