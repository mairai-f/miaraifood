...
const highlightContent = {
    education: {
        ...
        description: "O HappyCash foi criado para transformar processos complexos em uma experiência simples, rápida e organizada para empresas de todos os tamanhos."
    },
    journey: {
        title: "Tecnologia Que",
        highlight: "Gera Resultados",
        description: "Cada funcionalidade do HappyCash foi pensada para reduzir tarefas manuais, aumentar a produtividade e facilitar a rotina dos empresários."
    },
    experience: {
        title: "Controle Total",
        highlight: "Em Um Só Lugar",
        description: "Do caixa ao estoque, das vendas aos relatórios, o HappyCash conecta todas as áreas da empresa para uma gestão mais eficiente."
    }
};
...
function ExperienceTabSlider({ isLowPowerMode }: { isLowPowerMode: boolean }) {
    ...
    const tabs: TabItem[] = [
        { id: 'education', label: 'Plataforma', description: 'A base tecnológica do HappyCash ERP, criada para oferecer uma plataforma segura, organizada e escalável.' },
        { id: 'journey', label: 'História', description: 'Uma linha do tempo das melhorias, atualizações e avanços que construíram o HappyCash.' },
                                        ...
                                        <div className="lg:col-span-5 space-y-8">
                                            ...
                                            >
                                                ...
                                                <p className="text-xl text-neutral-500 dark:text-neutral-400 max-w-md leading-relaxed">
                                                     Navegue pela evolução do HappyCash ERP. Escolha uma categoria para explorar as principais melhorias e avanços da plataforma.
                                                </p>
                                            </motion.div>
