...
export function BlogContent({ initialPosts }: { initialPosts: any[] }) {
    ...
    const categories = ['all', 'gestao', 'pdv', 'estoque', 'financeiro', 'novidades'];
            ...
            <div className="relative z-10 w-full pt-[25vh]">
                ...
                <header className="sticky top-[25vh] z-0 pb-12 flex flex-col items-center justify-center pointer-events-auto h-auto">
                    <div className="relative z-10 max-w-5xl mx-auto text-center px-4">
                        ...
                        >
                            Um espaço dedicado a compartilhar conteúdos sobre gestão empresarial, tecnologia, vendas e estratégias para melhorar a operação dos negócios com o HappyCash ERP.
                        </motion.p>
                    </div>
                </header>
                    ...
                    <div className="flex flex-col md:flex-row gap-10 mb-16 items-end justify-between border-b border-foreground/5 pb-8">
                        <div className="flex flex-wrap gap-x-12 gap-y-6">
                            {categories.map((cat) => {
                                const count = cat === 'all'
                                    ? initialPosts.length
                                    : initialPosts.filter(b => b.category === cat).length;
                                ...
                                return (
                                    ...
                                    >
                                        <span className="relative">
                                            {cat === 'all' ? 'Todos os Conteúdos' : t(`categories.${cat}`)}
