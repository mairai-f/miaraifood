    ...
    return (
        <div className="w-full max-w-6xl mx-auto py-20 px-4 md:px-8">
            <div className="flex flex-col items-center mb-16 relative z-10 text-center">
                ...
                <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4">Perguntas frequentes</h2>
...
export default function ContactPage() {
    ...
    const row1Real = ['whatsapp', 'instagram'].map(getSocialItem);
            ...
            >
                ...
                <div className="container-creative px-4 md:px-8 max-w-[1800px] mx-auto pb-40">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
                        ...
                        {/* LEFT COLUMN (Removed Lanyard) */}
                        <div className="col-span-1 lg:col-span-2 hidden lg:block relative lg:sticky top-0 h-[400px] md:h-[500px] lg:h-[90vh] pointer-events-none z-20">
                        </div>
