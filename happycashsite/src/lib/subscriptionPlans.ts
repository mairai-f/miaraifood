...
export const publicPlanContent: Record<PublicPlanId, PublicPlanContent> = {
  ...
  pro: {
    ...
    summary: "Tudo do Completo com desktop PRO, chave por maquina, Android e offline local por 24 horas.",
    description: "Plano para operar no web, desktop PRO e Android com preparo offline de contingencia e login de operador com usuario e PIN.",
    features: [
      "Tudo do Plano Completo",
      "Desktop para Windows e Linux",
      "Chave da empresa em cada maquina nova",
      "Login de operador com usuario e PIN",
      "Offline local por ate 24 horas",
      "App Android",
      "Impressao Bematech",
