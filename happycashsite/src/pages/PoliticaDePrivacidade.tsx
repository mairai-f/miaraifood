...
const PoliticaDePrivacidade = () => (
  <LegalDocumentPage
    ...
    description="Esta política explica como tratamos dados pessoais no HappyCash, incluindo site, cadastro, área do cliente, sistema PDV, controle de fiado, estoque, HappyCashFood, HappyCash Agenda e recursos relacionados."
    updatedAt={updatedAt}
    sections={[
      {
        title: "1. Quem somos e como falar conosco",
        paragraphs: [
          "O HappyCash é uma plataforma para gestão comercial, controle de fiado, PDV, estoque, comandas, agenda e produtos relacionados. Para assuntos de privacidade, suporte ou exercício de direitos de titular, entre em contato pelo email happycashsupport@gmail.com.",
          "Quando uma loja usa o HappyCash para cadastrar seus próprios clientes, produtos, vendas, dívidas, comandas ou agendamentos, a loja é responsável pela decisão sobre esses dados. O HappyCash atua como fornecedor da tecnologia usada para armazenar e processar essas informações conforme a configuração feita pelo usuário da conta.",
        ],
      },
      {
        ...
        bullets: [
          ...
          "Dados operacionais inseridos pelo usuário: clientes, telefones, histórico de fiado, vendas, pagamentos, produtos, estoque, despesas, comandas, mesas, agendamentos e observações cadastradas no sistema.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Executar funcionalidades do sistema, como PDV, fiado, estoque, comandas, agenda, relatórios e cobranças.",
