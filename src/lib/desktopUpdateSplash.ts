  ...
  switch (status.status) {
    case "disabled":
      return {
        ...
        detail: "O MIAR AI/FOOD vai abrir normalmente enquanto você estiver em desenvolvimento local.",
        progress: null,
        tone: "warning",
        primary: false,
    ...
    case "publishing":
      return {
        ...
        detail: status.error || "O MIAR AI/FOOD vai tentar novamente automaticamente em instantes.",
        progress: null,
        tone: "warning",
        primary: false,
        animateEllipsis: false,
    ...
    case "downloaded":
      return {
        label: `Atualizando para a nova versão${versionSuffix}`,
        detail: "Download concluído. Reiniciando o MIAR AI/FOOD para instalar a atualização.",
        progress: 100,
        tone: "default",
        primary: true,
        animateEllipsis: true,
    ...
    case "installing":
      return {
        label: `Atualizando para a nova versão${versionSuffix}`,
        detail: "Instalação iniciada. O MIAR AI/FOOD será fechado e aberto novamente.",
        progress: 100,
        tone: "default",
        primary: true,
        animateEllipsis: true,
    ...
    case "idle":
      ...
      return {
        ...
        detail: `Canal ${status.channel || "latest"} validado para a versão atual do MIAR AI/FOOD.`,
        progress: null,
        tone: "default",
        primary: false,
        animateEllipsis: false,
