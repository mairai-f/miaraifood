...
const settingsNavigationItems: SettingsNavigationItem[] = [
  ...
  { path: '/configuracoes/filiais', section: 'filiais', title: 'Filiais e terminais', description: 'Lojas, terminais e escopo operacional.', icon: MapPinned, featureKey: 'settings.manage', permissionKey: 'multi_store.manage', runtimeScope: 'both' },
  { path: '/configuracoes/catalogo', section: 'catalogo', title: 'Catalogo avancado', description: 'Marcas, grupos, unidades e tabelas.', icon: PackageSearch, featureKey: 'settings.manage', permissionKey: 'products.manage', runtimeScope: 'both' },
  ...
  { path: '/configuracoes/pagamentos', section: 'pagamentos', title: 'Pagamentos', description: 'Pix e provedores de pagamento do estabelecimento.', icon: CreditCard, featureKey: 'settings.manage', permissionKey: 'settings.manage', runtimeScope: 'both' },
  { path: '/configuracoes/mesas', section: 'mesas', title: 'Mesas e QR Codes', description: 'Gerencie mesas e imprima QR Codes.', icon: ClipboardList, featureKey: 'food.tables', permissionKey: 'food.tables.manage', runtimeScope: 'both' },
  { path: '/configuracoes/qrmenu', title: 'QR Menu', description: 'Cardápio, categorias, fotos e disponibilidade.', icon: ClipboardList, featureKey: 'food.qrmenu', permissionKey: 'food.qrmenu.manage', runtimeScope: 'both' },
