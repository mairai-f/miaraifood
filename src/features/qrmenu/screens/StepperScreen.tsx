    ...
    <div className="relative flex min-h-screen flex-col bg-[#050b14] p-4 text-slate-100 overflow-hidden">
      ...
      <div className="relative z-10 mb-4 flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={skip}
          className="text-sm font-medium text-slate-400 underline underline-offset-2 hover:text-slate-200"
        >
          pular
        </button>
      </div>
          ...
          <Step>
            ...
            <div className="flex items-center justify-center gap-4 py-4">
              <button
                ...
                className="h-12 w-12 rounded-full bg-slate-800 text-xl font-bold text-slate-200 hover:bg-slate-700"
              >
                −
              </button>
              <span className="w-12 text-center text-3xl font-bold">{headcount}</span>
              <button
                type="button"
