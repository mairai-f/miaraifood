...
const navItems = [
  ...
  { path: '/comandas', label: 'Comandas', icon: ClipboardList, shortcut: '3', roles: ['admin', 'operator', 'waiter'], featureKey: 'service_tickets.use' },
  { path: '/clientes', label: 'Clientes', icon: Users, shortcut: '4', roles: ['admin', 'operator'], featureKey: 'clients.manage' },
  { path: '/produtos', label: 'Produtos', icon: Package, shortcut: '5', roles: ['admin', 'operator'], featureKey: 'products.manage' },
  { path: '/estoque', label: 'Estoque', icon: Boxes, shortcut: '6', roles: ['admin'], featureKey: 'stock.manage' },
  { path: '/relatorios', label: 'Relatórios', icon: BarChart3, shortcut: '7', roles: ['admin'], featureKey: 'reports.view' },
  { path: '/financeiro', label: 'Financeiro', icon: DollarSign, shortcut: '8', roles: ['admin'], featureKey: 'financial.manage' },
  { path: '/operacoes', label: 'Operações', icon: ClipboardList, roles: ['admin'], featureKey: 'financial.manage' },
  { path: '/notas', label: 'Notas', icon: FileText, roles: ['admin'], featureKey: 'notes.manage' },
