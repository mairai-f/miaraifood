      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="border-yellow-400/15 bg-black/45 shadow-[0_24px_60px_rgba(0,0,0,0.35)] backdrop-blur-md">
          <CardHeader className="space-y-3 text-center">
            ...
            <CardDescription>
              Em cada máquina nova, informe a chave da empresa para reconhecer o cadastro antes do login com usuário e senha ou PIN.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {recognizedCompany && (
              <div className="rounded-xl border border-primary/20 bg-primary/5 p-4 text-sm text-muted-foreground">
                ...
                <p className="mt-1">
                  Empresa reconhecida. Agora o login pode seguir com o usuário e senha ou PIN desta loja.
                </p>
              </div>
            )}
          </CardContent>
