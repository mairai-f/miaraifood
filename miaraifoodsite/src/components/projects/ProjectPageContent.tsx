...
export function ProjectPageContent({ project, isLowPowerMode }: { project: Project; isLowPowerMode?: boolean }) {
    ...
    const handleExit = () => {
        if (typeof window !== 'undefined' && document.referrer.includes('/funcionalidades')) {
            router.back();
        } else {
                ...
                >
                    ...
                    <div className="w-full">
                        ...
                        <div className="font-mono text-sm text-emerald-500/80 mb-8 h-6 flex items-center">
                            <Typewriter examples={[
                                "Iniciando visão geral dessa função...",
                                "Carregando especificações técnicas...",
                                "Processando indicadores de vendas..."
                            ]} />
                        </div>
                    </div>
                </motion.div>
                        ...
                        <div className="sticky top-20 space-y-8">
                            ...
                            <div className="p-6 rounded-2xl bg-white dark:bg-secondary/5 border border-black/20 dark:border-white/10 backdrop-blur-sm shadow-sm dark:shadow-none">
                                ...
                                <div className="flex flex-col gap-3">
                                    {project.demoUrl && (
                                        <motion.a
                                            href="https://wa.me/5512988918792?text=Ol%C3%A1%2C%20gostaria%20de%20testar%20a%20funcionalidade%20do%20MIAR AI/FOOD"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl font-bold text-sm bg-foreground text-background hover:opacity-90 shadow-lg shadow-black/20"
