...
const INITIAL_CHIPS = [
  {
    ...
    description: "Controle vendas, clientes e operações do negócio",
    icon: BrainCircuit,
  },
  {
    id: 2,
    title: "Dados & Relatórios",
    description: "Transforme informações em decisões inteligentes",
    icon: Database,
  },
  {
    id: 3,
    title: "Tecnologia & Performance",
    description: "Uma plataforma segura, rápida e preparada para crescer",
    icon: Code2,
  },
];
