...
void main() {
  ...
  vec3 backdrop = mix(vec3(0.03, 0.08, 0.05), vec3(1.0), step(0.5, uLightMode));
...
export default function GhostFibers({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uGrain: { value: 0.05 },
        uLightMode: { value: 0 },
        uLineColor: { value: new Float32Array(hexToRgb('#06100A')) },
        uGlowColor: { value: new Float32Array(hexToRgb('#70E000')) },
      },
    });
  ...
  useEffect(() => {
    ...
    const uniforms = context.program.uniforms as Record<string, { value: any }>;
