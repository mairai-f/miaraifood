...
function MegaBoxBig({ href, icon: Icon, title, desc, theme, pathname, onClick }: any) {
...
function MegaBoxSmall({ href, icon: Icon, title, desc, theme, pathname, onClick }: any) {
    const isActive = pathname === href || pathname?.startsWith(`${href}/`);
...
export default function CardNav({
    ...
    const aboutItem = items.find(i => i.label === "MIAR AI/FOOD") || items[0];
    const allHrefs = ['/funcionalidades', '/sobre', '/recursos', '/central-de-ajuda', '/conteudos', '/telas', '/termos'];
                        ...
                        <div className={cn(
                            ...
                            <div className="flex-1 p-5 flex flex-col gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <MegaBoxBig href="/funcionalidades" icon={Rocket} title="Funcionalidades" desc="Tudo o que você precisa em um só lugar" theme={theme} pathname={pathname} />
                                    <MegaBoxBig href="/sobre" icon={Briefcase} title="Sobre Nós" desc="A história e missão do MIAR AI/FOOD" theme={theme} pathname={pathname} />
                                </div>
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-4 relative z-10">
                                    <MegaBoxSmall href="/recursos" icon={Navigation} title="Recursos" desc="Tecnologia conectada aos equipamentos" theme={theme} pathname={pathname} />
                                    <MegaBoxSmall href="/central-de-ajuda" icon={Trophy} title="Central de Ajuda" desc="Como usar o sistema" theme={theme} pathname={pathname} />
                                    <MegaBoxSmall href="/conteudos" icon={BookOpen} title="Conteúdos" desc="Hub de conteúdo e negócios" theme={theme} pathname={pathname} />
                                </div>
                            </div>
                            ...
                            <div className={cn(
                                ...
                                <SidebarLink href="/telas" icon={ImageIcon} title="Telas do Sistema" desc="Demonstração visual do MIAR AI/FOOD" theme={theme} pathname={pathname} />
                                <SidebarLink href="/termos" icon={FileText} title="Termos e Privacidade" desc="Condições de uso e segurança" theme={theme} pathname={pathname} />
                            </div>
                        </div>
                    </motion.div>
                )}
