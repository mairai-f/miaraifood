            ...
            <div className="max-w-[1536px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20">
                <div className="relative z-10 w-full lg:w-1/2">
                    <BlockInTextCard
                        ...
                        text={
                            <>
                                <strong><Hover3DFlipText text="Pronto para transformar a gestão da sua empresa?" /></strong> <Hover3DFlipText text="Conheça o MIAR AI/FOOD e descubra como controlar vendas, estoque, financeiro e clientes em uma única plataforma." />
                            </>
                        }
                        examples={[
                ...
                <div className="relative z-10 w-full lg:w-1/2 hidden md:flex justify-center lg:justify-end items-center">
                    <div className="relative group p-2 rounded-full bg-gradient-to-b from-[#70E000]/30 to-[#006400]/20 border border-[#70E000]/40 shadow-[0_0_60px_rgba(112,224,0,0.25)] hover:shadow-[0_0_90px_rgba(112,224,0,0.4)] transition-all duration-500">
                        <div className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden relative">
                            <img
                                src="/miarai.webp"
                                alt="Atendente Virtual IA MIAR"
                                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-[#050b14]/60 via-transparent to-transparent pointer-events-none" />
                        </div>
                    </div>
                </div>
            </div>
