...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'Frente de Caixa PDV', description: 'Atendimento rápido e intuitivo com finalização de vendas simplificada.', orbitIndex: 0, position: 0.1, imageUrl: "/telasdosistema/pdvfinalizandovenda.webp" },
        { label: 'Fiado Digital', description: 'Gestão da caderneta de clientes com histórico de compras e cobrança via WhatsApp.', orbitIndex: 1, position: 0.25, imageUrl: "/telasdosistema/clientes.webp" },
        { label: 'Controle de Estoque', description: 'Movimentações de entrada, saída, alertas de produtos e inventário.', orbitIndex: 0, position: 0.45, imageUrl: "/telasdosistema/estoque.webp" },
        { label: 'Relatórios & Dashboards', description: 'Indicadores financeiros e operacionais em tempo real para tomada de decisão.', orbitIndex: 1, position: 0.65, imageUrl: "/telasdosistema/relatorios.webp" },
        { label: 'Financeiro & Caixa', description: 'Controle de sangrias, suprimentos e histórico de fechamento de caixa.', orbitIndex: 0, position: 0.85, imageUrl: "/telasdosistema/Financeiro.webp" },
        { label: 'Notas Fiscais', description: 'Emissão de documentos fiscais e cupom direto do caixa.', orbitIndex: 1, position: 0.05, imageUrl: "/telasdosistema/notafiscal.webp" },
    ],
    journey: [
        { label: 'Módulo de Comandas', description: 'Gestão de mesas, pedidos e atendimento para bares e restaurantes.', orbitIndex: 0, position: 0.15, imageUrl: "/telasdosistema/comandas.webp" },
        { label: 'Precificação Inteligente', description: 'Cálculo de margem de lucro e custo de produtos automatizado.', orbitIndex: 1, position: 0.35, imageUrl: "/telasdosistema/precificaçao.webp" },
        { label: 'Gestão de Produtos', description: 'Cadastro rápido de itens com fotos e código de barras.', orbitIndex: 0, position: 0.55, imageUrl: "/telasdosistema/produtos.webp" },
        { label: 'Operações em Lote', description: 'Atualização rápida de preços e estoque.', orbitIndex: 1, position: 0.75, imageUrl: "/telasdosistema/operaçoes.webp" },
        { label: 'Fechamento de Caixa', description: 'Conferência cega e relatórios diários de caixa.', orbitIndex: 0, position: 0.9, imageUrl: "/telasdosistema/fechamentodecaixa.webp" },
        { label: 'Multi-dispositivos', description: 'Acesso simultâneo via computador, tablet e celular.', orbitIndex: 1, position: 0.02, imageUrl: "/telasdosistema/pdv.webp" },
    ],
    experience: [
        { label: 'Segurança de Dados', description: 'Criptografia e backup contínuo das informações da sua empresa.', orbitIndex: 0, position: 0.2, imageUrl: "/telasdosistema/relatorios.webp" },
        { label: 'Alta Velocidade', description: 'Respostas instantâneas para evitar filas no caixa.', orbitIndex: 1, position: 0.45, imageUrl: "/telasdosistema/pdvfinalizandovenda.webp" },
        { label: 'Interface Amigável', description: 'Design limpo e intuitivo que não exige treinamento complexo.', orbitIndex: 0, position: 0.6, imageUrl: "/telasdosistema/pdv.webp" },
        { label: 'Suporte Dedicado', description: 'Atendimento humanizado direto no WhatsApp.', orbitIndex: 1, position: 0.8, imageUrl: "/telasdosistema/clientes.webp" },
        { label: 'Escalabilidade', description: 'Acompanha o crescimento do seu negócio.', orbitIndex: 0, position: 0.95, imageUrl: "/telasdosistema/Financeiro.webp" },
        { label: 'Nuvem e Offline', description: 'Sincronização inteligente sem parar a operação.', orbitIndex: 1, position: 0.1, imageUrl: "/telasdosistema/estoque.webp" },
    ]
};
                ...
                <div className="relative z-20 space-y-8 lg:-ml-28 lg:pr-12">
                    ...
                    >
                        ...
                        <div className="pt-4">
                            ...
                            >
                                Ver Funcionalidades <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                            </Link>
                        </div>
                    </motion.div>
                </div>
