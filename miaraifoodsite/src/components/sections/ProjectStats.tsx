            ...
            <div className="container-creative relative z-10 px-4 sm:px-6 md:px-8">
                ...
                >
                    ...
                    <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
                        Cada funcionalidade do MIAR AI/FOOD foi pensada para reduzir tarefas manuais, aumentar a produtividade e facilitar a rotina dos empresários.
                    </p>
                </motion.div>
