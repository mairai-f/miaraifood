    ...
    return (
        <section className="relative py-32 bg-foreground text-background overflow-hidden flex flex-col items-center justify-center text-center px-6">
            ...
            >
                ...
                <Link href="/conteudos" className="group relative inline-flex items-center gap-4 px-12 py-6 bg-background text-foreground rounded-full font-bold uppercase tracking-widest hover:scale-105 transition-transform duration-300">
