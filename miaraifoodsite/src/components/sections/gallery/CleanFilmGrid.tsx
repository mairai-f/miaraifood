        ...
        const fetchImages = async () => {
            try {
                ...
                const formattedItems = images.map((img, index) => {
                    const rawName = img.filename.split('.')[0];
                    ...
                    return {
                        ...
                        type: 'image',
                        category: 'Telas MIAR AI/FOOD',
                        date: '2026',
                        thumbnail: img.src,
                        url: img.src,
                        description: `Demonstração da tela de ${formattedTitle} do sistema MIAR AI/FOOD.`
                    };
                });
