...
const showcaseMembers = [
    {
        ...
        role: "Agilidade e Facilidade de Operação",
        description: "Vendas em poucos cliques com emissão de nota e cupom fiscal.",
        period: "Módulo Principal",
        image: "/telasdosistema/pdvfrentedecaixa.png",
        social: { website: '/central-de-ajuda' }
    },
    {
        id: 'hc-2',
        name: "Fiado Digital & Clientes",
        role: "Gestão de Caderneta de Clientes",
        description: "Controle de débitos, limites de crédito e notificações via WhatsApp.",
        period: "Módulo Comercial",
    ...
    },
    {
        ...
        role: "Inventário e Alertas Automatizados",
        description: "Gestão de entradas, saídas, curva ABC e cálculo de margem de lucro.",
        period: "Módulo Operacional",
        image: "/telasdosistema/controleseuestoque.png",
        social: { website: '/central-de-ajuda' }
    },
    {
        id: 'hc-4',
        name: "Relatórios & Dashboards",
        role: "Visão em Tempo Real",
        description: "Acompanhe faturamento, margens e métricas cruciais da sua empresa.",
        period: "Módulo Gestão",
    ...
    },
    {
        ...
        role: "Controle Total do Fluxo",
        description: "Fechamento de caixa, sangrias, suprimentos e histórico de movimentações.",
        period: "Módulo Financeiro",
        image: "/telasdosistema/configuraçoes.png",
        social: { website: '/central-de-ajuda' }
    },
    {
        id: 'view-more',
        name: 'Ver Ecossistema Completo',
        role: "Explore todos os módulos do MIAR AI/FOOD",
...
const AboutLeadIn = () => {
    return (
        <div className="w-full max-w-[1650px] mx-auto px-6 py-6 flex justify-center items-center">
            {/* The Reference Card Container (MIAR Dark Spruce Style without red lines) */}
            <motion.div
                initial="hidden"
                whileInView="show"
                whileHover="hover"
                ...
                className="relative w-full bg-[#06190e] dark:bg-[#041209] border border-[#006400]/30 p-6 md:p-12 lg:p-16 overflow-hidden shadow-2xl rounded-3xl transition-all duration-500 group"
            >

                {/* 1. Grid Background Overlay (Dynamic Colors) */}
                <div className="absolute inset-0 z-0 bg-[radial-gradient(circle,_#ffffff0d_1px,_transparent_1px)] bg-[size:20px_20px] pointer-events-none transition-opacity" />
                ...
                <div className="absolute inset-0 z-30 pointer-events-none overflow-hidden">
                    <motion.div
                        ...
                        className="absolute inset-y-0 w-[150%] md:w-[75%] bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-[-25deg]"
                    />
                </div>
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex justify-between items-start mb-6 md:mb-10">
                        <span className="text-[#70E000] text-[10px] md:text-xs font-black uppercase tracking-[0.3em]">VISÃO GERAL</span>
                        <span className="text-[#38B000]/70 text-[9px] font-mono tracking-widest uppercase hidden md:block">MIAR AI/FOOD</span>
                    </div>

                    {/* Massive Typography - Quote Style */}
                    <div className="mb-8 md:mb-14 relative cursor-default">
                        {/* Original Text with glow */}
                        <h2 className="text-[32px] sm:text-[48px] md:text-[64px] lg:text-[76px] xl:text-[88px] font-bold tracking-tight leading-[0.92] text-white transition-all duration-700 group-hover:drop-shadow-[0_0_20px_rgba(56,176,0,0.3)]">
                            <span className="text-[#38B000]/40 mr-2 transition-colors duration-700 group-hover:text-[#70E000]/60">"</span>
                            Impulsionando <span className="text-zinc-400 font-medium transition-colors duration-700 group-hover:text-zinc-200">Negócios</span>. <br className="hidden md:block" />
                            <span className="font-serif italic font-normal text-white/90 lowercase opacity-90 transition-opacity duration-700 group-hover:opacity-100">onde operação encontra inteligência</span>
                            <span className="text-[#38B000]/40 ml-1 transition-colors duration-700 group-hover:text-[#70E000]/60">."</span>
                        </h2>
                    </div>

                    {/* Detail Grid */}
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 border-t border-emerald-950/60 pt-8 md:pt-12">
                        {/* Left narrative */}
                        <div className="md:col-span-5">
                            <p className="text-base md:text-lg lg:text-xl font-medium text-zinc-300 leading-relaxed tracking-tight">
                                O MIAR AI/FOOD foi criado para ajudar empresas a terem mais controle sobre suas operações, oferecendo uma solução simples, moderna e eficiente.
                            </p>
                        </div>
                        ...
                        <div className="md:col-span-7 flex flex-col sm:flex-row gap-8 text-[13px]">
                            <div className="flex-1 space-y-3">
                                <span className="text-[#70E000] font-bold uppercase tracking-widest block border-b border-emerald-950/60 pb-3">Recursos</span>
                                <p className="text-zinc-400 leading-relaxed">
                                    Uma plataforma criada para integrar processos, simplificar a operação e dar mais controle à gestão.
                                </p>
                                <p className="text-[#38B000] font-bold italic">
                                    Integração Completa
                                </p>
                            </div>
                            <div className="flex-1 space-y-3 flex flex-col">
                                <span className="text-[#70E000] font-bold uppercase tracking-widest block border-b border-emerald-950/60 pb-3">Experiência</span>
                                <p className="text-zinc-400 leading-relaxed">
                                    Projetado para ser intuitivo e escalável, ajudando você no dia a dia.
                                </p>
                                <div className="mt-6 md:mt-auto pt-4">
                                    <span className="text-3xl lg:text-4xl font-signature text-[#9EF01A]">MIAR AI/FOOD</span>
                                </div>
                            </div>
                        </div>
                    </div>
