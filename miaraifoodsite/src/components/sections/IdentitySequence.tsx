        ...
        <div className="relative w-screen h-full flex flex-col items-center justify-center overflow-hidden bg-background dark:bg-black">
            ...
            >
                ...
                >
                    ...
                    <div className="relative w-full h-[60vh] md:h-[100svh] flex flex-col items-center flex-shrink-0 px-4 md:px-10 lg:px-20">
                            ...
                            <div className="absolute inset-0 overflow-hidden">
                                ...
                                >
                                    <div className="absolute inset-0">
                                        {/* Parallax wrapper */}
                                        <div className="absolute w-[calc(100%+100px)] h-full md:h-[130vh] -top-[15vh] -left-[50px]">
                                            <motion.div 
                                                className="relative h-full w-full" 
                                                style={{ y: isMobile ? 0 : imageParallaxY }}
                                            >
                                                <Image
