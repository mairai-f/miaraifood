            ...
            <div className="absolute inset-0 flex items-center justify-center z-10 px-4">
                ...
                >
                    ...
                    <p className="w-full max-w-4xl text-center text-[clamp(10px,1.2vw,14px)] font-bold text-foreground/50 dark:text-white/50 tracking-[clamp(0.1em,0.4em,0.4em)] leading-relaxed md:leading-[2.2] uppercase">
                        A Tecnologia por Trás do MIAR AI/FOOD
                        <br className="hidden md:block" />
                       Organização, desempenho e inovação trabalhando juntos para simplificar a rotina de empresas e comerciantes.
                    </p>
                </motion.div>
            </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 absolute inset-0 z-20 pointer-events-none grid grid-cols-12 gap-4 h-full items-end pb-[10vh]">
            ...
            */}
            ...
            <div className="col-span-3 col-start-2">
                <ParallaxImg
                    scrollY={scrollY}
                    src="/telasdosistema/pdvfinalizandovenda.webp"
                    alt="PDV Vendas"
                    start={800}
                    end={-1500}
            ...
            <div className="col-span-3 col-start-10 mb-32">
                <ParallaxImg
                    scrollY={scrollY}
                    src="/telasdosistema/clientes.webp"
                    alt="Fiado Clientes"
                    start={1000}
                    end={-1500}
            ...
            <div className="col-span-4 col-start-5 mb-10">
                <ParallaxImg
                    scrollY={scrollY}
                    src="/telasdosistema/estoque.webp"
                    alt="Controle Estoque"
                    start={900}
                    end={-1800}
            ...
            <div className="col-span-3 col-start-1 mb-64">
                <ParallaxImg
                    scrollY={scrollY}
                    src="/telasdosistema/relatorios.webp"
                    alt="Relatórios Gerenciais"
                    start={1200}
                    end={-2000}
            ...
            <div className="col-span-4 col-start-8 mb-40">
                <ParallaxImg
                    scrollY={scrollY}
                    src="/telasdosistema/Financeiro.webp"
                    alt="Financeiro Caixa"
                    start={1100}
                    end={-2000}
                    className="w-full shadow-2xl rounded-2xl border border-white/10 aspect-video object-cover"
                />
