      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-foreground mb-4 leading-tight tracking-tight drop-shadow-md">
            <Link href={`/conteudos/${currentPost.slug}`} className="hover:text-primary transition-colors line-clamp-2">
              {currentPost.title}
            </Link>
          </h2>
          <div className="flex items-center gap-6">
            <Link
              href={`/conteudos/${currentPost.slug}`}
  ...
  const CARDS = [
    {
      ...
      description: "Nossos últimos projetos concluídos e em desenvolvimento.",
    ...
    {
      title: "Galeria",
      description: "Marcos curados da jornada.",
      visual: (
    ...
    {
      title: "Artigos publicados em diversas categorias de engenharia.",
      description: "Artigos publicados em diversas categorias.",
    ...
    },
    {
      ...
      description: "Registro em tempo real dos últimos artigos publicados.",
    ...
    },
    {
      ...
      description: "Explore os últimos projetos concluídos e em desenvolvimento.",
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-4 md:px-8 lg:px-12 pt-4 pb-20 flex-grow flex flex-col">
        ...
        <div className="mt-14 flex flex-col items-center justify-center py-10 border-t border-border/50">
          ...
          >
            Este espaço reúne conteúdos sobre gestão, vendas, estoque, financeiro e tecnologia para ajudar negócios a trabalharem de forma mais simples e organizada.

Informações práticas, dicas e novidades do MIAR AI/FOOD para transformar conhecimento em decisões melhores no dia a dia da sua empresa.

© 2026 MIAR AI/FOOD. Todos os direitos reservados.
