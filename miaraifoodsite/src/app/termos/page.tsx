    ...
    <main className="min-h-screen bg-zinc-50 dark:bg-black selection:bg-primary/30">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            Conheça as regras de utilização do MIAR AI/FOOD e saiba como tratamos e protegemos os dados do seu negócio.
          </motion.p>
        </div>
      </section>
          ...
          <div className="bg-white/70 dark:bg-zinc-900/50 backdrop-blur-xl border border-black/5 dark:border-white/10 rounded-3xl p-8 md:p-12 shadow-xl shadow-black/5">
            ...
            <div className="mb-24">
              ...
              <div className="text-lg leading-relaxed text-zinc-600 dark:text-zinc-400 mb-12">
                Esta Política de Privacidade explica como o MIAR AI/FOOD coleta, utiliza, armazena, protege e compartilha dados pessoais relacionados ao seu site, cadastro, área do cliente, sistema ERP, PDV, controle de fiado, estoque e demais recursos disponibilizados pela plataforma. Ao utilizar o MIAR AI/FOOD, determinados dados poderão ser tratados para permitir o funcionamento dos serviços, proteger as contas, processar pagamentos, prestar suporte e cumprir obrigações legais.
              </div>

              <Section title="1. Quem somos" delay={0.1}>
                <p>O MIAR AI/FOOD é um ecossistema inteligente que conecta o cliente, o estabelecimento e toda a operação, oferecendo recursos como cardápio digital, PDV, gestão de mesas, cozinha (KDS), delivery, controle de estoque, inteligência artificial e relatórios.</p>
                <p>Para assuntos relacionados à privacidade, proteção de dados ou exercício de direitos previstos na legislação aplicável, entre em contato pelo e-mail: <strong><a href="mailto:suporte@miaraifood.com.br" className="text-primary hover:underline">suporte@miaraifood.com.br</a></strong></p>
                <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mt-6 mb-3">Controlador dos dados</h3>
                <p>Em relação aos dados pessoais tratados pelo próprio MIAR AI/FOOD para funcionamento da conta, contratação dos serviços, atendimento, segurança e demais finalidades próprias da plataforma, o MIAR AI/FOOD poderá atuar como controlador dos dados.</p>
                <p>Quando um estabelecimento utiliza o MIAR AI/FOOD para processar seus próprios clientes, produtos, vendas, pedidos, pagamentos ou outras informações relacionadas à sua operação, a loja é responsável por definir as finalidades e os meios essenciais desse tratamento. Nessas situações, o MIAR AI/FOOD atua como fornecedor da tecnologia e poderá tratar esses dados na medida necessária para disponibilizar, manter, proteger e melhorar os serviços contratados.</p>
              </Section>
              ...
              <Section title="2. Dados que podemos coletar" delay={0.2}>
                ...
                <ul className="list-disc pl-5 space-y-1 mb-4">
                  ...
                  <li>histórico de pedidos, reservas, vendas, pagamentos, despesas;</li>
              ...
              <Section title="3. Para que utilizamos os dados" delay={0.3}>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 list-none pl-0 mt-4">
                  {[
                    ...
                    "Executar funcionalidades do PDV e Cardápio", "Disponibilizar delivery e gestão de salão",
              ...
              <Section title="4. Compartilhamento e Bases Legais" delay={0.4}>
                ...
                <p>O MIAR AI/FOOD poderá compartilhar informações com fornecedores (hospedagem, banco de dados, pagamentos, e-mails, segurança) na medida necessária para a execução dos serviços. Também poderemos compartilhar informações por determinação legal, para prevenir fraudes ou proteger direitos.</p>
              </Section>
              ...
              <Section title="5. Segurança e Direitos dos Titulares" delay={0.5}>
                ...
                <p>Os titulares de dados poderão exercer direitos previstos na LGPD, como acesso, correção e exclusão. Solicitações referentes aos dados tratados diretamente pelo MIAR AI/FOOD podem ser encaminhadas para <strong>suporte@miaraifood.com.br</strong>. Se os dados foram cadastrados por um estabelecimento, a solicitação deve ser feita ao próprio comércio.</p>
              </Section>
            </div>
            ...
            <div>
              ...
              <div className="text-lg leading-relaxed text-zinc-600 dark:text-zinc-400 mb-12">
                Estes Termos de Uso regulam o acesso e utilização do site, área do cliente, sistema MIAR AI/FOOD, PDV, recursos de desktop, funcionalidades offline, planos, testes gratuitos e demais serviços disponibilizados pela plataforma. Ao criar uma conta, acessar o site, contratar um plano ou utilizar qualquer recurso do MIAR AI/FOOD, você declara que leu, compreendeu e concorda com estes Termos de Uso.
              </div>

              <Section title="1. Aceite e Responsabilidades do Usuário">
                <p>Ao utilizar o MIAR AI/FOOD, você concorda com estes Termos. Caso represente uma empresa, declara possuir autorização. O usuário se compromete a:</p>
                <ul className="list-disc pl-5 space-y-1 mb-4">
              ...
              <Section title="2. Planos, Testes e Pagamentos">
                <p>O MIAR AI/FOOD disponibiliza planos pagos e testes gratuitos. Os pagamentos podem ser via Pix, boleto ou cartão. A liberação de recursos depende da confirmação do pagamento. Em caso de atraso ou chargeback, o acesso pode ser suspenso. O usuário pode cancelar a assinatura a qualquer momento, o que interrompe futuras renovações.</p>
              </Section>

              <Section title="3. Dados da Loja e Relatórios">
                <p>Os dados inseridos (clientes, vendas, pedidos) permanecem da loja. O usuário autoriza a plataforma a processá-los para prestar o serviço. As informações financeiras e operacionais do sistema são ferramentas de apoio: o MIAR AI/FOOD não substitui obrigações e responsabilidades fiscais do estabelecimento.</p>
              </Section>

              <Section title="4. Propriedade Intelectual e Limitação de Responsabilidade">
                <p>A marca, código, layout e identidade visual pertencem ao MIAR AI/FOOD. É proibida a cópia, engenharia reversa ou revenda. Na extensão máxima permitida pela lei, o MIAR AI/FOOD não se responsabiliza por perdas devido a lançamentos incorretos, falta de conferência, problemas de conexão do usuário ou falhas em seus dispositivos.</p>
              </Section>
            </div>
          </div>
        </div>
