                ...
                <div className="flex flex-col lg:flex-row relative items-start">
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div variants={staggerItem}>
                                <NavItem label="Começando" active={activeCategory === 'começando no miarai'} onClick={() => setActiveCategory('começando no miarai')} count={getCategoryCount('começando no miarai')} isCollapsed={isSidebarCollapsed} />
                            </motion.div>
                            <motion.div variants={staggerItem}>
