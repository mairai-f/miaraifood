...
const highlightContent = {
    education: {
        ...
        description: "O MIAR AI/FOOD foi criado para transformar processos complexos em uma experiência simples, rápida e organizada para empresas de todos os tamanhos."
    },
    journey: {
        title: "Tecnologia Que",
        highlight: "Gera Resultados",
        description: "Cada funcionalidade do MIAR AI/FOOD foi pensada para reduzir tarefas manuais, aumentar a produtividade e facilitar a rotina dos empresários."
    },
    experience: {
        title: "Controle Total",
        highlight: "Em Um Só Lugar",
        description: "Do caixa ao estoque, das vendas aos relatórios, o MIAR AI/FOOD conecta todas as áreas da empresa para uma gestão mais eficiente."
    }
};
...
function ExperienceTabSlider({ isLowPowerMode }: { isLowPowerMode: boolean }) {
    ...
    const tabs: TabItem[] = [
        { id: 'education', label: 'Plataforma', description: 'A base tecnológica do MIAR AI/FOOD, criada para oferecer uma plataforma segura, organizada e escalável.' },
        { id: 'journey', label: 'História', description: 'Uma linha do tempo das melhorias, atualizações e avanços que construíram o MIAR AI/FOOD.' },
        { id: 'experience', label: 'Inovação', description: 'Detalhes do desenvolvimento dos módulos, recursos e soluções criadas para simplificar a gestão empresarial.' },
    ];

    const categories = [
        { id: 'professional', label: 'Desenvolvimento da Plataforma', icon: Briefcase, color: 'bg-blue-600', prefix: 'prof-' },
        { id: 'leadership', label: 'Dados e Gestão', icon: Users, color: 'bg-purple-600', prefix: 'lead-' },
        { id: 'volunteer', label: 'Infraestrutura e Tecnologia', icon: Heart, color: 'bg-orange-500', prefix: 'vol-' },
        { id: 'certifications', label: 'Atualizações e Melhorias', icon: Award, color: 'bg-emerald-500', prefix: 'cert-' },
    ];
                                        ...
                                        <div className="lg:col-span-5 space-y-8">
                                            ...
                                            >
                                                ...
                                                <p className="text-xl text-neutral-500 dark:text-neutral-400 max-w-md leading-relaxed">
                                                     Navegue pela evolução do MIAR AI/FOOD. Escolha uma categoria para explorar as principais melhorias e avanços da plataforma.
                                                </p>
                                            </motion.div>
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 relative z-10">
                                                        ...
                                                        <p className="text-sm font-medium text-neutral-500 dark:text-neutral-400 line-clamp-1 group-hover:text-neutral-900 dark:group-hover:text-neutral-200 transition-colors">
                                                            Clique para explorar {cat.label.toLowerCase()} 
                                                        </p>
                                                    </div>
