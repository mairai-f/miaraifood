...
export const portfolioData: PortfolioData = {
  personal: {
    ...
    bio: "MIAR AI/FOOD é a solução completa para gerenciar seu comércio. Sistema ERP moderno que organiza venda, cliente, produto, cobrança e relatório em uma rotina simples. Com mais de 500+ clientes acompanhados, 50K+ vendas registradas e 10K+ produtos controlados, oferecemos uma plataforma confiável que torna a operação visível e controlável em qualquer lugar.",
    avatar: "/telasdosistema/pdvfrentedecaixa.png",
    location: "Brasil",
    email: "suporte@miaraifood.com.br",
    phone: "+55 12 98891-8792",
    resumeUrl: "/termos",
    website: "https://www.miaraifood.com.br",
    languages: [
  ...
  longDescription:
    "O PDV do MIAR AI/FOOD foi desenvolvido para tornar o processo de venda mais rápido, simples e organizado. Registre produtos, controle pagamentos, acompanhe vendas e mantenha o estoque atualizado automaticamente em uma única plataforma.",
...

  {
    ...
    },
    {
      ...
      longDescription:
        "A Caderneta Fiado Digital do MIAR AI/FOOD transforma a operação de lojas que vivem de fiado. Elimina a necessidade de cadernos físicos oferecendo controle digital completo: clientes identificados, saldo sempre visível, histórico organizado e mensagens de cobrança prontas para enviar via WhatsApp. Ideal para pequenas e médias lojas que precisam gerenciar crédito com segurança.",
...

  {
    ...
    solution:
      "O MIAR AI/FOOD facilita o envio de mensagens de cobrança pelo WhatsApp.",
  },
],
    },
    {
...
repoUrl: "#",
     ...
     challengesAndSolutions: [
  {
    ...
    solution:
      "O MIAR AI/FOOD mantém o estoque organizado e atualizado conforme as movimentações da empresa.",
  },
...

  {
    ...
    },
    {
      ...
      longDescription:
        "Os Relatórios & Análise do MIAR AI/FOOD transformam dados brutos em insights acionáveis. Veja o desempenho do seu negócio através de DRE completo, margens de lucro por produto, rankings de vendas e tendências. Todos os dados sincronizados em tempo real para que você sempre tenha visibilidade sobre a operação.",
      ...
      challengesAndSolutions: [
  {
    ...
    solution:
      "Os relatórios do MIAR AI/FOOD organizam os dados da operação para facilitar o acompanhamento dos resultados.",
  },
  ...
  challengesAndSolutions: [
    {
      ...
      solution:
        "O MIAR AI/FOOD organiza entradas, saídas e informações do caixa em um único sistema, reduzindo controles manuais.",
    },
  ...
  installation: [
    {
      title: "Configuração Inicial",
      code: "Ative o modo offline no ambiente MIAR AI/FOOD e configure o dispositivo.",
      type: "text",
    },
  ...
  longDescription:
    "O módulo de Gestão de Usuários e Permissões do MIAR AI/FOOD permite controlar quem pode acessar cada recurso do sistema. Defina funções, limite acessos e organize a operação de acordo com a responsabilidade de cada colaborador. Mais segurança para a empresa e mais controle sobre todas as atividades realizadas no sistema.",
  ...
  longDescription:
    "O módulo de Integrações de Pagamento do MIAR AI/FOOD facilita o recebimento das vendas conectando diferentes formas de pagamento ao sistema. Tenha mais agilidade no caixa, organize recebimentos e acompanhe as movimentações financeiras de forma centralizada.",
  ...
  installation: [
    ...
    {
      title: "Integração",
      code: "Conecte os meios de pagamento disponíveis no ambiente MIAR AI/FOOD.",
      type: "text",
    },
...
},
{
    ...
    image: "/telasdosistema/cadastreprodutos.png",
    description: "Gerenciamento completo de produtos com preços, categorias, códigos de barras e informações organizadas.",
    longDescription: "O módulo de Produtos do MIAR AI/FOOD facilita o cadastro e gerenciamento dos itens vendidos pela empresa. Controle informações importantes como preço, estoque, categorias, códigos de barras e detalhes de cada produto em uma estrutura organizada.",
  ...
  slug: "miaraifood-gestao-de-clientes",

  title: "MIAR AI/FOOD Gestão de Clientes",
  ...
  challengesAndSolutions: [
    {
      ...
      solution:
        "A MIAR AI/FOOD centraliza os dados dos consumidores, permitindo acesso rápido e organizado durante a operação.",
    },
  ...
  challengesAndSolutions: [
    {
      ...
      solution:
        "A MIAR AI/FOOD organiza os dados da operação em relatórios claros para facilitar o acompanhamento do negócio.",
    },
  ...
  slug: "miaraifood-controle-de-estoque",

  title: "MIAR AI/FOOD Controle de Estoque",

  description:
    "Sistema completo para controle de produtos, movimentações e organização do estoque do seu negócio.",

  longDescription:
    "O módulo de Controle de Estoque da MIAR AI/FOOD permite acompanhar produtos, entradas, saídas e movimentações em tempo real. Desenvolvido para facilitar a rotina de comerciantes, o sistema ajuda a evitar perdas, melhorar o controle de mercadorias e manter o negócio sempre organizado.",
  ...
  challengesAndSolutions: [
    {
      ...
      solution:
        "A MIAR AI/FOOD centraliza o controle de estoque, permitindo acompanhar produtos e movimentações de forma organizada.",
    },
...

{
  ...
  slug: "miaraifood-controle-de-acessos",

  title: "MIAR AI/FOOD Controle de Usuários",

  description:
    "Gerenciamento de usuários, permissões e níveis de acesso para maior segurança na operação do sistema.",

  longDescription:
    "O módulo de Controle de Usuários da MIAR AI/FOOD permite administrar quem pode acessar cada área do sistema. Com permissões personalizadas, empresas conseguem organizar equipes, limitar acessos e garantir maior segurança durante a operação diária.",
  ...
  challengesAndSolutions: [
    {
      ...
      solution:
        "O controle de permissões da MIAR AI/FOOD permite definir acessos conforme a função de cada colaborador.",
    },
  ...
  slug: "miaraifood-operacao-offline",

  title: "MIAR AI/FOOD Operação Offline",

  description:
    "Sistema preparado para manter a operação do comércio funcionando mesmo em situações de instabilidade de conexão.",

  longDescription:
    "A tecnologia Offline da MIAR AI/FOOD foi desenvolvida para garantir continuidade na operação dos estabelecimentos. Mesmo em ambientes com internet instável, o sistema permite realizar vendas e acessar informações essenciais, sincronizando os dados automaticamente quando a conexão é restabelecida. Uma solução criada para evitar interrupções e manter o comércio sempre funcionando.",
  ...
  features: [
...

    {
      ...
      items: [
        "**Controle Centralizado**: Informações organizadas dentro do ecossistema MIAR AI/FOOD.",
  ...
  installation: [
    {
      ...
      code:
        "Instale o MIAR AI/FOOD Desktop\nConfigure o ambiente local\nConecte sua conta MIAR AI/FOOD",
  ...
  challengesAndSolutions: [
    {
      ...
      solution:
        "A tecnologia offline da MIAR AI/FOOD mantém a operação ativa mesmo sem conexão temporária.",
    },
...

    {
      ...
      solution:
        "A MIAR AI/FOOD combina desempenho local e sincronização online para oferecer maior estabilidade operacional.",
    },
  ],
},
    {
  ...
  challengesAndSolutions: [
    {
      ...
      solution:
        "A MIAR AI/FOOD organiza as movimentações financeiras em um único sistema, facilitando o controle diário.",
    },
  ...
  slug: "miaraifood-caderneta-fiado",

  title: "MIAR AI/FOOD Caderneta Fiado",

  description:
    "Controle de vendas a prazo para acompanhar clientes, valores pendentes e histórico de pagamentos.",

  longDescription:
    "A Caderneta Fiado da MIAR AI/FOOD foi desenvolvida para facilitar o controle de vendas realizadas a prazo. O sistema permite registrar compras dos clientes, acompanhar valores em aberto e manter um histórico organizado de pagamentos. Uma solução criada para pequenos e médios comerciantes que precisam oferecer crédito aos seus clientes com mais segurança e organização.",
  ...
  features: [
...

    {
      ...
      items: [
        ...
        "**Dados Atualizados**: Informações sincronizadas dentro do ecossistema MIAR AI/FOOD.",
  ...
  challengesAndSolutions: [
    {
      ...
      solution:
        "A MIAR AI/FOOD digitaliza esse processo, mantendo todas as informações organizadas e acessíveis.",
    },
  ...
  },
  {
    ...
    description: 'O MIAR AI/FOOD na palma da mão ou no balcão da loja.',
    responsibilities: [
  ...
  achievements: [
    ...
    },
    {
      ...
      issuer: "Suporte MIAR AI/FOOD",
      date: "2026-08-01",
      description: "Ao abrir o aplicativo MIAR AI/FOOD pela primeira vez no seu computador ou celular, ele pedirá a Chave da Licença. Cole a chave que você copiou no passo anterior, aceite os termos e clique em 'Validar e continuar'. Isso vinculará o dispositivo à sua loja.",
      category: "Começando no MIAR AI/FOOD",
      type: "Tutorial",
      image: "/telasdosistema/paineldecontrole.png"
    },
  ...
  hardSkills: [
    ...
    },
    {
      ...
      level: "advanced",
      category: "pagamentos",
      description: "Conecte seus recebimentos ao ecossistema do MIAR AI/FOOD e simplifique a operação de pagamentos.",
    },
    {
      name: "NFC-e",
      level: "expert",
    ...
    },
    {
      ...
      level: "advanced",
      category: "conectividade",
      description: "Utilize o MIAR AI/FOOD no computador para uma operação mais completa e integrada ao ambiente do estabelecimento.",
    },
    {
      name: "Mobile",
      level: "intermediate",
    ...
    },
    {
      ...
      level: "advanced",
      category: "conectividade",
      description: "Mantenha as informações da operação sincronizadas entre os dispositivos conectados ao ambiente do MIAR AI/FOOD.",
    },
  ],
  softSkills: [
    {
  ...
  blogs: [
    {
      ...
      content: `
        ...
        <p class="mb-8">Usar um ERP como o MIAR AI/FOOD permite que cada venda feita no caixa (PDV) dê baixa automática no estoque. Você não precisa contar nada no final do dia. O sistema também avisa quando um produto está acabando, sugerindo o momento ideal de compra.</p>
      `,
      toc: [
      ...
      author: { name: "Equipe MIAR AI/FOOD", avatar: "/telasdosistema/pdvfrentedecaixa.png" },
      readTime: "5",
    },
    {
      id: "blog-2",
      ...
      content: `
        ...
        <p class="mb-8">Um bom PDV integrado com leitor de código de barras é obrigatório. Vender "de cabeça" ou digitando preços manualmente destrói qualquer controle de estoque. O MIAR AI/FOOD permite bipar o produto e já atualizar o estoque na mesma hora.</p>
      `,
      toc: [
    ...
    },
    {
      ...
      content: `
        ...
        <h2 id="digitalizacao" class="text-3xl font-bold mb-6 text-foreground scroll-mt-32">Caderneta Digital no MIAR AI/FOOD</h2>
        <p class="mb-8">O MIAR AI/FOOD possui a funcionalidade de controle de crediário/fiado integrada. Quando você finaliza a venda no PDV e escolhe "Fiado", a dívida vai direto para o cadastro do cliente. O sistema soma tudo automaticamente e você pode enviar a cobrança via WhatsApp direto pelo sistema. Profissionalismo puro!</p>
      `,
      toc: [
    ...
    },
    {
      ...
      content: `
        ...
        <p class="mb-8">Use um sistema centralizado. Com o MIAR AI/FOOD, os cadastros são únicos, as entradas via Nota Fiscal atualizam o estoque na hora, e as trocas geram estornos automáticos. O controle deixa de ser uma dor de cabeça e passa a ser uma rotina fácil.</p>
      `,
      toc: [
    ...
    },
    {
      ...
      content: `
        ...
        <p class="mb-8">O ideal é utilizar um índice chamado Markup. O sistema MIAR AI/FOOD ajuda você a preencher o custo de compra, a margem que deseja obter e os impostos, sugerindo imediatamente o Preço de Venda ideal para que você nunca pague para trabalhar.</p>
      `,
      toc: [
    ...
    },
    {
      ...
      content: `
        ...
        <h2 id="miaraifood" class="text-3xl font-bold mb-6 text-foreground scroll-mt-32">Fechamento Cego no MIAR AI/FOOD</h2>
        <p class="mb-8">Uma das melhores práticas é o "Fechamento Cego". O operador de caixa digita no sistema o quanto ele contou, sem saber o que o sistema espera. O MIAR AI/FOOD fará a comparação e apontará a diferença exata (sobra ou quebra), gerando um relatório gerencial. Muito mais segurança para você.</p>
      `,
      toc: [
        { id: "importancia", label: "O Momento da Verdade" },
        { id: "passos", label: "Passo a Passo" },
        { id: "miaraifood", label: "Fechamento Cego" }
      ],
      image: "/telasdosistema/pdvfrentedecaixa.png",
      date: "2026-02-15",
      category: "financeiro",
    ...
    },
    {
      ...
      content: `
        ...
        <p class="mb-8">Fazer essa conta na mão ou na planilha todo mês é cansativo e sujeito a erros. O MIAR AI/FOOD gera a DRE Gerencial automaticamente com base nas vendas do PDV, custo dos produtos e contas pagas cadastradas no módulo financeiro. Com um clique, você sabe a resposta que mais importa: "Estou tendo lucro?"</p>
      `,
      toc: [
    ...
    },
    {
      ...
      content: `
        ...
        <p class="mb-8">Você não precisa adivinhar o que está encalhado. O relatório de <em>Produtos sem Movimentação</em> do MIAR AI/FOOD te mostra exatamente os itens que não tiveram vendas nos últimos 30, 60 ou 90 dias. A informação na sua mão, na hora certa, para tomar uma atitude rápida!</p>
      `,
      toc: [
    ...
    },
    {
      ...
      content: `
        ...
        <h2 id="miaraifood-pdv" class="text-3xl font-bold mb-6 text-foreground scroll-mt-32">O PDV MIAR AI/FOOD</h2>
      ...
      toc: [
        ...
        { id: "miaraifood-pdv", label: "O PDV MIAR AI/FOOD" }
      ],
      image: "/telasdosistema/pdvfrentedecaixa.png",
      date: "2026-01-25",
      category: "pdv",
    ...
    },
    {
      ...
      content: `
        ...
        <p class="mb-8">No MIAR AI/FOOD, sabemos que a implementação é a parte crítica. Por isso, nosso sistema é 100% visual e intuitivo, feito para que qualquer pessoa (mesmo sem grande conhecimento de informática) consiga operar no primeiro dia de uso, com auxílio do nosso time de suporte.</p>
      `,
      toc: [
    ...
    },
    {
      ...
      content: `
        ...
        <p class="mb-8">Ter esses números na ponta do lápis seria inviável. É por isso que um sistema moderno como o MIAR AI/FOOD traz Dashboards visuais. Assim que você loga no sistema, os gráficos apontam o Ticket Médio, comparativo com meses anteriores e o ranqueamento dos produtos mais vendidos. Gestão visual é gestão ágil!</p>
      `,
      toc: [
  ...
  gallery: [
    {
      ...
      date: "2026-01-20",
      type: "image",
      url: "/telasdosistema/pdvfrentedecaixa.png",
      category: "vendas",
    },
    {
      id: "gal-2",
      ...
      date: "2026-01-21",
      type: "image",
      url: "/telasdosistema/controleseuestoque.png",
      category: "gestao",
    },
    {
      id: "gal-3",
      ...
      date: "2026-01-22",
      type: "image",
      url: "/telasdosistema/paineldecontrole.png",
      category: "financeiro",
    },
    {
      id: "gal-4",
      ...
      date: "2026-01-23",
      type: "image",
      url: "/telasdosistema/telademesas.png",
      category: "vendas",
    },
    {
      id: "gal-5",
