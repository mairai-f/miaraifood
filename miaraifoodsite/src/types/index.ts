...
export interface Skill {
    ...
    category: 'frontend' | 'backend' | 'database' | 'devops' | 'mobile' | 'ai' | 'data' | 'blockchain' | 'software' | 'cloud' | 'other' | 'pagamentos' | 'fiscal' | 'operacao' | 'conectividade';
    description?: string;
}
...
export interface Tool {
    name: string;
    icon: string;
    category: 'ide' | 'design' | 'productivity' | 'devops' | 'communication' | 'other' | 'plataforma' | 'pagamento' | 'infra' | 'web' | 'comunicacao';
    relatedProjects?: string[];
}
